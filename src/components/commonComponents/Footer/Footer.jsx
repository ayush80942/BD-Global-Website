          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start text-sm text-gray-300">
                ...
                <span>D 194, First Floor, Okhla Phase 1, New Delhi - 110019</span>
              </div>
            </div>
            ...
            <button 
              ...
              className="mt-6 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-md flex items-center text-sm font-medium transition-colors">
