...
const Footer = () => {
  return (
    <footer className="bg-custom-black text-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 text-sm mb-6 leading-relaxed">
              Your trusted partner for comprehensive business solutions. From startup registration to ongoing compliance, we help businesses thrive.
            </p>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start text-sm text-gray-300">
                <svg className="w-4 h-4 mr-3 mt-0.5 text-teal-400" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                </svg>
                <span>123 Business Tower, Commercial Complex, Mumbai - 400001</span>
              </div>
            </div>
            
            {/* WhatsApp Button */}
            <button className="mt-6 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-md flex items-center text-sm font-medium transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/pricing" className="text-gray-300 hover:text-teal-400 text-sm transition-colors">
                  Pricing
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/contact" className="text-gray-300 hover:text-teal-400 text-sm transition-colors">
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            {/* Follow Us */}
            <div>
              <h4 className="text-white font-medium text-base mb-3">Follow Us</h4>
              <div className="flex space-x-3">
                <a href="#" className="w-8 h-8 bg-gray-700 hover:bg-teal-600 rounded-full flex items-center justify-center transition-colors">
        ...
        <div className="border-t border-gray-700 mt-8 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
            <p>© 2025 BD Global. All rights reserved. | Registered under Company Act 2013</p>
            <p className="mt-2 md:mt-0">CIN Member Firm: [ISO 9001:2015 Certified]</p>
          </div>
        </div>
      </div>
    </footer>
